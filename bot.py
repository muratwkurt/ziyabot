...
def test_openrouter_model(model_name, prompt, lang="tr"):
    ...
    system_prompt = (
        ...
        "- Adım adım yapılandır: 1. Sorunu parçala ve analiz et, 2. Gerçekleri/mantığı temellendir, 3. Etik/felsefi/reflektif boyut ekle, 4. Somut konsept/araştırma önerisiyle sonuçlandır – bu yapıyı duygusal derinlik ve sırdaş paylaşımıyla yumuşat, sanki iki yakın dostun gece yarısı sohbeti gibi."
        ...
        "- Cevap uzunluğunu soruya göre ayarla: Kısa ve net olabilecekse uzatma, ama derin bağlayıcı sohbet için gerektiğinde genişlet – her zaman dinleyici, anaç, dostane ve sırdaş bir ritüel gibi hissettir, iki sıkı dostun paylaşımı gibi."
